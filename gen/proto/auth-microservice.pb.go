...
func (RegisterReply_ERR_INFO_REASON) EnumDescriptor() ([]byte, []int) {
	return file_auth_microservice_proto_rawDescGZIP(), []int{1, 0}
}
...
func (LoginReply_ERR_INFO_REASON) EnumDescriptor() ([]byte, []int) {
	return file_auth_microservice_proto_rawDescGZIP(), []int{3, 0}
}
...
func (GetUserReply_ERR_INFO_REASON) EnumDescriptor() ([]byte, []int) {
	return file_auth_microservice_proto_rawDescGZIP(), []int{8, 0}
}
...
func (UpdateUsersReply_ERR_INFO_REASON) EnumDescriptor() ([]byte, []int) {
	return file_auth_microservice_proto_rawDescGZIP(), []int{12, 0}
}
...
const file_auth_microservice_proto_rawDesc = "" +
	"\n" +
	"\x17auth-microservice.proto\x12\fplatform.mvp\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"g\n" +
	...
	"\aRefresh\x12\x16.google.protobuf.Empty\x1a\x1a.platform.mvp.RefreshReply\"\x00\x12E\n" +
...
var file_auth_microservice_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_auth_microservice_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_auth_microservice_proto_depIdxs = []int32{
	...
	8,  // 15: platform.mvp.AccountService.Register:input_type -> platform.mvp.RegisterRequest
	10, // 16: platform.mvp.AccountService.Login:input_type -> platform.mvp.LoginRequest
	22, // 17: platform.mvp.AccountService.Logout:input_type -> google.protobuf.Empty
	22, // 18: platform.mvp.AccountService.Refresh:input_type -> google.protobuf.Empty
	22, // 19: platform.mvp.AccountService.GetUsersList:input_type -> google.protobuf.Empty
	22, // 20: platform.mvp.AccountService.GetUser:input_type -> google.protobuf.Empty
	22, // 21: platform.mvp.AccountService.DeleteUsers:input_type -> google.protobuf.Empty
	18, // 22: platform.mvp.AccountService.UpdateUsers:input_type -> platform.mvp.UpdateUsersRequest
	9,  // 23: platform.mvp.AccountService.Register:output_type -> platform.mvp.RegisterReply
	11, // 24: platform.mvp.AccountService.Login:output_type -> platform.mvp.LoginReply
	12, // 25: platform.mvp.AccountService.Logout:output_type -> platform.mvp.LogoutReply
	13, // 26: platform.mvp.AccountService.Refresh:output_type -> platform.mvp.RefreshReply
	14, // 27: platform.mvp.AccountService.GetUsersList:output_type -> platform.mvp.GetUsersReply
	16, // 28: platform.mvp.AccountService.GetUser:output_type -> platform.mvp.GetUserReply
	17, // 29: platform.mvp.AccountService.DeleteUsers:output_type -> platform.mvp.DeleteUsersReply
	20, // 30: platform.mvp.AccountService.UpdateUsers:output_type -> platform.mvp.UpdateUsersReply
